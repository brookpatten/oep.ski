...
namespace Amphibian.Oep.Configuration
{
    public class OepApiConfiguration
    {
        ...
        public static (IConfiguration,OepApiConfiguration) LoadFromJsonConfig(IConfigurationBuilder builder=null, params string[] basePaths)
        {
            ...
            var serviceConfiguration = config.Get<OepApiConfiguration>();
